...
Anthropic が Claude Opus 5 を正式リリース。Fable 5 に近い性能を半額で提供し、コーディングや知識作業の評価で新たな最先端を達成。従来モデルより効率的で、同等以上の性能を低コストで実現。Constitutional AI による行動監査で最も整合性が高く、無謀な行動や欺瞞的行動の発生率が最低。全有料プランと Claude API で利用可能で、Opus 4.8 と同価格。Fast モードでは通常の約 2.5 倍の速度で動作。

- **ソース**: [Reddit r/ClaudeAI](https://www.reddit.com/r/ClaudeAI/comments/1v5h6o9/introducing_claude_opus_5)
- **重要度**: 10/10
- **タグ**: opus, release, 新機能
