...
- 断定しすぎない
- 原文が他媒体経由の伝聞情報（「関係者によると」「〜が報じた」等）の場合は、要約でも伝聞と分かる表現にする
- 記事が販促・PR・有料商材の宣伝である場合は、その性質を要約に明記する
...
採点の追加ルール:
- まとめ・キュレーション・転載・PR・販促記事など、独自の一次情報を含まない派生コンテンツは上限5とする
- 研究論文（arXiv等）は、広く注目される実績や重大な結果がない限り5〜6とする
- 6〜7に集中させず、基準に照らして1〜10を使い分ける
"""
